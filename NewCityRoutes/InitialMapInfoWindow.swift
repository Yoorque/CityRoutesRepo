...
class InitialMapInfoWindow: UIView {
    ...
    @IBOutlet var stationUnderView: UIView! {
        didSet {
            ...
            stationName.widthAnchor.constraint(equalTo: stationUnderView.widthAnchor, constant: -8).isActive = true
    ...
    @IBOutlet var underView: UIView! {
        didSet {
            ...
            otherLinesLabel.centerYAnchor.constraint(equalTo: underView.centerYAnchor, constant: 0).isActive = true
            ...
            code.centerYAnchor.constraint(equalTo: underView.centerYAnchor, constant: 0).isActive = true
